...
Nombre del alumno: Sanchez Perez Keybin Daniel
...
fig, axes = plt.subplots(2, 1, figsize=(w, h*2.2)) # Aumenté un poco el alto para las leyendas
...
# Leyenda en la parte inferior de la primera gráfica
...
# Leyenda en la parte inferior de la segunda gráfica
ax2.legend(loc='upper center', bbox_to_anchor=(0.5, -0.25), ncol=4,
           fontsize=9, frameon=False)

plt.tight_layout()
plt.subplots_adjust(hspace=0.5) 
plt.savefig('musculoesqueleticopy.pdf', bbox_inches='tight')
plt.show()